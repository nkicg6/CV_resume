...
Website& I built my personal \href{https://nickgeorge.net}{website} using Clojure, a functional lisp which runs on the JVM. I have written about using Clojure to develop ImageJ/Fiji plugins and have attempted other small projects with it. I write about programming and science on my website.\\
\end{tabular}
\section*{Other Skills, Experience, and Outreach}
\label{sec:org823aa60}
\begin{tabular}{lp{0.8\textwidth}}
